...
async function main() {
  ...
  await prisma.product.createMany({
    data: [
      ...
      { id: "A-002", name: "月収7桁を叩き出すCSS講座【完全無料】", price: 50000, },
      { id: "A-003", name: "資格不要！ゼロから始める非正規暗号通貨運用術", price: 30000, },
      { id: "A-004", name: " パワポで月収100万：架空案件で学ぶ「営業芸」完全読本", price: 15000, },
    ],
  });
  ...
  await prisma.newsItem.createMany({
    data: [
      ...
      { title: "駅前のたこ焼き屋のWi-Fiが研究棟より速い問題", region: Region.OSAKA, publishedAt: new Date("2025-05-18"), },
      { title: "「一時的なスクリプト」が2年間も本番環境で動いていた件", region: Region.TOKYO, publishedAt: new Date("2025-05-18"), },
      { title: "MacOSでしか動作しないレポート提出システムが爆誕", region: Region.TOKYO, publishedAt: new Date("2025-05-19"), },
      { title: "サトウキビ畑から発見された謎の Raspberry Pi クラスタ", region: Region.OKINAWA, publishedAt: new Date("2025-05-19"), },
      { title: "深夜に現れる謎のコメットメッセージ「ほんまごめん」", region: Region.OSAKA, publishedAt: new Date("2025-05-20"), },
      { title: "秋葉原の裏路地にしか売ってない謎のWi-Fiモジュールが研究室で大活躍", region: Region.TOKYO, publishedAt: new Date("2025-05-21"), },
      { title: "リアルタイムOSが「うちなータイム」に感化されてスケジューラが瞑想状態に", region: Region.OKINAWA, publishedAt: new Date("2025-05-22"), },
    ],
  });
